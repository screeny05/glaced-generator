napi_value napi_glGetActiveUniform(napi_env env, napi_callback_info info){
    GET_NAPI_PARAMS_INFO(2, "glGetActiveUniform(program: number, index: number): GLESActiveInfo;");
